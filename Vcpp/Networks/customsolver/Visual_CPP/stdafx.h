...
// 
// See the use restrictions at <your ArcGIS install location>/DeveloperKit10.7/userestrictions.txt.
// 
...
//import esriSystem.olb
#import "\Program Files (x86)\ArcGIS\Desktop10.7\COM\esriSystem.olb" named_guids no_namespace raw_interfaces_only no_implementation \
...
//import esriSystemUI.olb
#import "\Program Files (x86)\ArcGIS\Desktop10.7\COM\esriSystemUI.olb" named_guids no_namespace raw_interfaces_only no_implementation
//import esriFramework.olb
#import "\Program Files (x86)\ArcGIS\Desktop10.7\COM\esriFramework.olb" named_guids no_namespace raw_interfaces_only no_implementation  \
  exclude("UINT_PTR")
//import esriGeometry.olb
#import "\Program Files (x86)\ArcGIS\Desktop10.7\COM\esriGeometry.olb" named_guids no_namespace raw_interfaces_only no_implementation \
  rename("ISegment", "ISegmentESRI")
//import esriGeoDatabase.olb
...
//import esriNetworkAnalyst.olb
#import "\Program Files (x86)\ArcGIS\Desktop10.7\COM\esriNetworkAnalyst.olb" named_guids, no_namespace, raw_interfaces_only, no_implementation
//import esriDisplay.olb
...
//import esriDataSourcesRaster.olb
#import "\Program Files (x86)\ArcGIS\Desktop10.7\COM\esriDataSourcesRaster.olb" raw_interfaces_only, raw_native_types, no_namespace, no_implementation named_guids
//import esriCarto.olb
#import "\Program Files (x86)\ArcGIS\Desktop10.7\COM\esriCarto.olb" raw_interfaces_only, raw_native_types, no_namespace, named_guids \
  exclude("UINT_PTR", "IConvertCacheStorageFormatJob", "IMapCacheExporterJob")

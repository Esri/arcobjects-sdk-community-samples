...
#import "\Program Files (x86)\ArcGIS\Desktop10.6\com\esriSystem.olb"  raw_interfaces_only raw_native_types no_namespace named_guids exclude("OLE_COLOR", "OLE_HANDLE", "VARTYPE", "XMLSerializer")
//import esriSystemUI.olb "libid:4ECCA6E2-B16B-4ACA-BD17-E74CAE4C150A"
#import "\Program Files (x86)\ArcGIS\Desktop10.6\com\esriSystemUI.olb"  raw_interfaces_only raw_native_types no_namespace named_guids exclude("IProgressDialog")
...
#import "\Program Files (x86)\ArcGIS\Desktop10.6\com\esriDataSourcesRaster.olb"  raw_interfaces_only raw_native_types no_namespace named_guids
//import esriCarto.olb "libid:45AC68FF-DEFF-4884-B3A9-7D882EDCAEF1"
#import "\Program Files (x86)\ArcGIS\Desktop10.6\com\esriCarto.olb"  raw_interfaces_only raw_native_types no_namespace named_guids exclude("OLE_COLOR", "OLE_HANDLE", "VARTYPE", "UINT_PTR")
//import esriOutput.olb "libid:7DB92CEC-CB65-420A-8737-FCD0722FD436"
#import "\Program Files (x86)\ArcGIS\Desktop10.6\com\esriOutput.olb"  raw_interfaces_only raw_native_types no_namespace named_guids
//import esriGeoprocessing.olb "libid:C031A050-82C6-4F8F-8836-5692631CFFE6"
#import "\Program Files (x86)\ArcGIS\Desktop10.6\com\esriGeoprocessing.olb"  raw_interfaces_only raw_native_types no_namespace named_guids
//import esri3DAnalyst.olb "libid:639FE90A-CC9A-48C6-AC1D-105FE50915B5"
#import "\Program Files (x86)\ArcGIS\Desktop10.6\com\esri3DAnalyst.olb"  raw_interfaces_only raw_native_types no_namespace named_guids exclude("OLE_COLOR", "OLE_HANDLE", "VARTYPE")
//import esriGlobeCore.olb "libid:00B329B5-265E-11d6-B2B4-00508BCDDE28"
#import "\Program Files (x86)\ArcGIS\Desktop10.6\com\esriGlobeCore.olb"  raw_interfaces_only raw_native_types no_namespace named_guids exclude("OLE_COLOR", "OLE_HANDLE", "VARTYPE")
//import esriControls.olb "libid:033364CA-47F9-4251-98A5-C88CD8D3C808"
#import "\Program Files (x86)\ArcGIS\Desktop10.6\com\esriControls.olb"  raw_interfaces_only raw_native_types no_namespace named_guids

//change this to the appropriate path if necessary
#include "\Program Files (x86)\ArcGIS\DeveloperKit10.6\include\CatIDs\ArcCATIDs.h"
#pragma warning(pop)

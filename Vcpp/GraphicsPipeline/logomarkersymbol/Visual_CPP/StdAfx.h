...
#import "\Program Files (x86)\ArcGIS\Desktop10.6\com\esriGeometry.olb" raw_interfaces_only raw_native_types no_namespace named_guids exclude("OLE_COLOR", "OLE_HANDLE", "ICursorPtr", "VARTYPE"), rename("ISegment", "ISegmentSample")
//import esriDisplay.olb "libid:59FCCD31-434C-4017-BDEF-DB4B7EDC9CE0"
#import "\Program Files (x86)\ArcGIS\Desktop10.6\com\esriDisplay.olb" raw_interfaces_only raw_native_types no_namespace named_guids exclude("OLE_COLOR", "OLE_HANDLE", "ICursorPtr", "VARTYPE"), rename("CMYK", "EsriDisplayCMYK"), rename("DrawText", "EsriDisplayDrawText")
//import esriFramework.olb "libid:866AE5D3-530C-11D2-A2BD-0000F8774FB5"
#import "\Program Files (x86)\ArcGIS\Desktop10.6\com\esriFramework.olb" raw_interfaces_only raw_native_types no_namespace named_guids exclude("OLE_COLOR", "OLE_HANDLE", "ICursorPtr", "VARTYPE", "UINT_PTR")
//import esriDisplayUI.olb "libid:016DF9D3-7E81-11D2-A2D1-0000F8774FB5"
#import "\Program Files (x86)\ArcGIS\Desktop10.6\com\esriDisplayUI.olb" raw_interfaces_only raw_native_types no_namespace named_guids exclude("OLE_COLOR", "OLE_HANDLE", "ICursorPtr", "VARTYPE")
#pragma warning(pop)

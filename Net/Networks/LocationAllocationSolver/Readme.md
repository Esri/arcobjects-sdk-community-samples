...
###Purpose  
This sample application demonstrates how to programmatically perform a Location–Allocation analysis. This sample shows how to load locations from a feature class, set solver parameters, execute the analysis, and obtain output results.  

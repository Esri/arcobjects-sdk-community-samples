...
Public NotInheritable Class CreateScaleText
    Inherits BaseTool
...
#End Region
    ...
    Public Sub New()
        ...
        MyBase.m_bitmap = New System.Drawing.Bitmap(GetType(CreateScaleText).Assembly.GetManifestResourceStream(GetType(CreateScaleText), "ScaleText.bmp"))
        MyBase.m_caption = "ScaleText"
        MyBase.m_category = "myCustomCommands(VBNet)"
        MyBase.m_message = "Add a scale text map surround"
        MyBase.m_name = "myCustomCommands(VBNet)_ScaleText"
        MyBase.m_toolTip = "Add a scale text"
    ...
    Public Overrides Sub OnMouseUp(ByVal Button As Integer, ByVal Shift As Integer, ByVal X As Integer, ByVal Y As Integer)
        ...
        styleGalleryItem = symbolForm.GetItem(esriSymbologyStyleClass.esriStyleClassScaleTexts)
        'Release the form
        symbolForm.Dispose()

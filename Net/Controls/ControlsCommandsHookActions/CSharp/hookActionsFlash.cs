...
{
    [Guid("9194A5FB-0CDC-41f9-B305-8AE8A23FDF5B")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("HookActions.hookActionFlash")]
    public sealed class hookActionsFlash : BaseCommand
    {
        ...
        public hookActionsFlash()
        {
            base.m_category = "HookActions";
            base.m_caption = "Flash selected features";  
            base.m_message = "Flash selected features";  
            base.m_toolTip = "Flash selected features"; 
            base.m_name = "HookActions_Flash";   
        }
        ...
        public override bool  Enabled
        {
	        ...
	        { 
                ...
                if (hookActions.get_ActionSupported(feature.Shape, esriHookActions.esriHookActionsFlash))
                    return true;
                else
                    return false;
	        }

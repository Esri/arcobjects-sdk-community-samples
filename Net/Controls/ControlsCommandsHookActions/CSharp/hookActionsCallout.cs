...
{
    [Guid("8C85062D-39FF-4027-8560-A2F95E24996E")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("HookActions.hookActionCallout")]
    public sealed class hookActionsCallout : BaseCommand
    {
        ...
        public hookActionsCallout()
        {
            base.m_category = "HookActions";
            base.m_caption = "Create callouts";
            base.m_message = "Create callouts";
            base.m_toolTip = "Create callouts";
            base.m_name = "HookActions_Callout";
        }
        ...
        public override bool Enabled
        {
            get
            {
                ...
                if (hookActions.get_ActionSupported(feature.Shape, esriHookActions.esriHookActionsCallout))
                    return true;
                else
                    return false;
            }
        ...
        public override void OnClick()
        {
            ...
            if (hookActions.get_ActionSupportedOnMultiple(array, esriHookActions.esriHookActionsCallout))

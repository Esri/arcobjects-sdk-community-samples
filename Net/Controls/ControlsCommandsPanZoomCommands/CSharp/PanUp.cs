...
namespace PanZoom
{
	...
	[Guid("1BA75CB7-7C7F-45e7-824B-DDB3C662A734")]

	public class PanUp : ICommand
	{
		...
		public PanUp()
		{
			...
			{
				m_bitmap = new System.Drawing.Bitmap(GetType().Assembly.GetManifestResourceStream(GetType(), "PanUp.bmp"));
				if(m_bitmap != null)
				{
		...
		public string Message
		{
			get
			{
				return "Pan display up by the pan factor percentage";
			}
		}
		...
		public int HelpContextID
		{
			get
			{
				// TODO:  Add PanUp.HelpContextID getter implementation
				return 0;
			}
		}
		...
		public string HelpFile
		{
			get
			{
				// TODO:  Add PanUp.HelpFile getter implementation
				return null;
			}
		}

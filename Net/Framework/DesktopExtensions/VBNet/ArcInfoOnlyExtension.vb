...
<ComClass(ArcInfoOnlyExtension.ClassId, ArcInfoOnlyExtension.InterfaceId, ArcInfoOnlyExtension.EventsId), _
 ProgId("DesktopExtensionsVB.ArcInfoOnlyExtension")> _
Public Class ArcInfoOnlyExtension
...
#Region "COM GUIDs"
    ...
    Public Const ClassId As String = "19787cd9-3b47-4321-a400-a2ad750fbf48"
    Public Const InterfaceId As String = "55a9fc6d-d2b9-4e40-949c-c609503f3d2d"
    Public Const EventsId As String = "2779a387-52ee-4b46-a53c-c5c622918ea5"
#End Region

    Private m_application As IApplication
    Private m_enableState As esriExtensionState

    Private Const RequiredProductCode As esriLicenseProductCode = esriLicenseProductCode.esriLicenseProductCodeAdvanced
...
#Region "IExtension Members"
    ...
    Public ReadOnly Property Name() As String Implements ESRI.ArcGIS.esriSystem.IExtension.Name
        Get
            Return "ArcInfoOnlyExtension_VB"
        End Get
    End Property
...
#Region "IExtensionConfig Members"
    Public ReadOnly Property Description() As String Implements ESRI.ArcGIS.esriSystem.IExtensionConfig.Description
        Get
            Return "Advanced Only Extension (VB.Net Sample)\r\n" + _
                "Copyright © ESRI 2006\r\n\r\n" + _
                "Only available with an Advanced product license."
        End Get
    End Property
    ...
    Public ReadOnly Property ProductName() As String Implements ESRI.ArcGIS.esriSystem.IExtensionConfig.ProductName
        Get
            Return "Advanced Extension (VB.Net)"
        End Get
    End Property

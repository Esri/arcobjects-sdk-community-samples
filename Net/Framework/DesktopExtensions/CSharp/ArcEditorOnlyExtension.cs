...
{
    [Guid("16567F33-694D-4ca7-AC11-BA30971C3DB4")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("DesktopExtensionsCS.ArcEditorOnlyExtension")]
    public class ArcEditorOnlyExtension : IExtension, IExtensionConfig
    {
        ...
        private const esriLicenseProductCode RequiredProductCode = esriLicenseProductCode.esriLicenseProductCodeStandard;
        ...
        public string Name
        {
            get
            {
                return "ArcEditorOnlyExtension_CS";
            }
        }
        ...
        public string Description
        {
            get
            {
                return "Standard only extension (C# Sample)\r\n" +
                    "Copyright � ESRI 2006\r\n\r\n" +

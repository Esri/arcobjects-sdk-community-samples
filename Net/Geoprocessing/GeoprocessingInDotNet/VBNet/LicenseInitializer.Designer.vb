...
Partial Friend Class LicenseInitializer
  ...
  Public Property AllowImplicitRuntimeBinding() As Boolean
    Get
      Return m_fallbackBinding
    End Get
    Set(ByVal value As Boolean)
      m_fallbackBinding = value
    End Set
  End Property
  ...
  ''' <remarks>
  ''' If no active runtime version has been loaded before license initialization, the 
  ''' ResolveVersionEvent is raised.
  '''</remarks>
  Public Function InitializeApplication(ByVal productCodes As esriLicenseProductCode(), ByVal extensionLics() As esriLicenseExtensionCode) As Boolean
    ...
    ' Force specific version! Otherwise it will load an pre-10 version if exist!
    If RuntimeManager.ActiveRuntime IsNot Nothing Then
      m_AoInit = New AoInitializeClass()
    Else
      ' Last chance - raise event
...
#Region "Helper methods"
  ...
  Private Function Initialize() As Boolean
    If m_AoInit Is Nothing Then Return False
...
#Region "Private members"
  ...
  Private m_fallbackBinding As Boolean = False
#End Region
